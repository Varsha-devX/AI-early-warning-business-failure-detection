...
async def upload_and_analyze(
    ...
    if len(financial_content) > 15 * 1024 * 1024:  # 15MB limit
        raise HTTPException(status_code=413, detail="File too large! This free-tier server only has 512MB RAM and cannot process files over 15MB. Please upload a smaller file.")
