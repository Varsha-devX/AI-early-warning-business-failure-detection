...
"""
    ...
    def _generate_template_report(self, company_name, financial_data, ratios,
        ...
        rec_section = recommendations.get("summary", "No recommendations generated.")
    ...
    def generate_pdf(self, report: dict, company_name: str) -> str:
        ...
        try:
            ...
            elements.append(Paragraph(
                "This report was generated by the AI Corporate Health & Early-Warning Intelligence Platform. "
